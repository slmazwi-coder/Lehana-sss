...
const SCHOOL_DATA_VERSION = 'lehana-v1';
...
const defaultContact: ContactInfo = {
  address: 'Castle Rock, Tsekong Location (Ward 8), P.O. Box 45, Mount Fletcher, 4770 (Eastern Cape)',
...
const defaultAbout: AboutInfo = {
  ...
  principalMessage: [
    ...
    'We believe that every child deserves quality education, and as a No-Fee school, we are proud to remove financial barriers to learning. I encourage all parents and guardians to partner with us in shaping the future of our learners.',
  ],
};
...
const defaultActivities: Activity[] = [
  ...
  { id: '6', name: 'Drama', category: 'Culture', description: 'Theatre and dramatic arts for creative expression.', image: '' },
];
