        ...
        <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="rounded-3xl border border-[#D4A017] bg-[#FDF8E8] p-6 sm:p-7 flex gap-4 items-start">
              <div className="p-3 rounded-2xl bg-white border border-[#D4A017] text-[#A8131C] shrink-0">
                <Megaphone size={22} />
              </div>
              <div className="min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  <div className="text-sm font-black uppercase tracking-widest text-[#A8131C]">Notice</div>
                ...
                <a href="/admissions" className="mt-4 inline-flex items-center gap-2 text-[#A8131C] font-bold">
            ...
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-6 sm:p-7 flex gap-4 items-start">
              <div className="p-3 rounded-2xl bg-white border border-gray-200 text-[#A8131C] shrink-0">
                <Megaphone size={22} />
              </div>
              <div className="min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  <div className="text-sm font-black uppercase tracking-widest text-[#A8131C]">Boarding</div>
                ...
                <a href="/boarding" className="mt-4 inline-flex items-center gap-2 text-[#A8131C] font-bold">
      ...
      <section className="py-12 bg-gray-50 -mt-4 mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stats.map((stat, i) => (
            ...
            >
              <div className="p-4 bg-[#FDF8E8] rounded-xl text-[#A8131C]">
                <stat.icon size={32} />
              </div>
              <div>
